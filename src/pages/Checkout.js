      ...
      <div className="row">
        <div className="col-lg-8">
          <div className="bg-white rounded shadow-sm overflow-hidden">
            <div className="address p-3 bg-light">
              <h6 className="m-0 text-dark d-flex align-items-center">Address <span className="small ml-auto"><Link to="/" className="font-weight-bold text-decoration-none text-success" data-toggle="modal" data-target="#exampleModal"><i className="icofont-location-arrow" /> Change</Link></span></h6>
            </div>
            <div className="p-3">
            ...
            <div className="p-3">
              <Link to="/" className="text-success text-decoration-none w-100" data-toggle="modal" data-target="#paymentModal">
                <div className="d-flex align-items-center">
                  <i className="icofont-credit-card" /> <span className="ml-3">Edit Payment Method</span> <i className="icofont-rounded-right ml-auto" />
                </div>
              </Link>
            </div>
            <div className="address p-3 bg-light">
            ...
            <div>
              <div className="accordion" id="accordionExample">
                <div className="d-flex align-items-center" id="headingThree">
                  <Link className="p-3 d-flex align-items-center text-decoration-none text-success w-100" type="button" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                    <i className="icofont-badge mr-3" /> Add Promo Code
                    <i className="icofont-rounded-down ml-auto" />
                  </Link>
                </div>
                <div id="collapseThree" className="collapse p-3 border-top" aria-labelledby="headingThree" data-parent="#accordionExample">
                  <div className="clearfix">
                    <div className="input-group-sm mb-2 input-group">
                      <input placeholder="Enter promo code" type="text" className="form-control" />
                      <div className="input-group-append"><button id="button-addon2" type="button" className="btn btn-success"><i className="icofont-percent" /> APPLY</button></div>
                    </div>
                    <div className="mb-0 input-group">
                      <div className="input-group-prepend"><span className="input-group-text"><i className="icofont-ui-message" /></span></div>
        ...
        <div className="col-lg-4">
          <div className="sticky_sidebar">
            ...
            <Link to="/successfull" className="btn btn-success btn-lg btn-block mt-3 mb-3">Place Order</Link>
