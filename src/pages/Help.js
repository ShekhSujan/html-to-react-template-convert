    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-4">
          <div className="osahan-account bg-white rounded shadow-sm overflow-hidden">
            <div className="p-4 profile text-center border-bottom">
              ...
              <p className="small text-muted m-0"><Link  className="__cf_email__" data-cfemail="5f363e32302c3e373e311f38323e3633713c3032">[email&nbsp;protected]</Link></p>
            </div>
        ...
        <div className="col-lg-8 p-4 bg-white rounded shadow-sm">
          <h4 className="mb-4 profile-title">Help &amp; Support</h4>
          <div className="help_support">
            <Link  className="text-decoration-none"><button className="p-3 btn-light border d-flex align-items-center btn w-100 mb-1" type="button">
