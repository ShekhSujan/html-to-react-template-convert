                ...
                <div className="col-lg-12">
                  <div className="osahan-status">
                    <div className="p-3 status-order bg-white border-bottom d-flex align-items-center">
                      <p className="m-0"><i className="icofont-ui-calendar" /> 16 June, 11:30AM</p>
                      <Link to="" className="text-success ml-auto text-decoration-none">Review</Link>
                    </div>
                    <div className="p-3 border-bottom">
                      <h6 className="font-weight-bold">Order Status</h6>
                      <div className="tracking-wrap">
                        <div className="my-1 step active">
                          <span className="icon text-success"><i className="icofont-check" /></span>
